...
import { navigateBack, useDidShow, getCurrentInstance } from '@tarojs/taro';
...
const Scan: FC<{}> = () => {
    ...
    const renderInfo = () => {
        if (type === '1') {
            return <Text className="flash-text">扫码未见异常</Text>;
        }else{
            return <Text className="text">未见异常</Text>;
        }
    }
